  ...
  <section id="">
    ...
    <article id='derecha'>
     ...
     <?php if(session::getInstance()->hasCredential('admin')):?>
      <a class="btn  btn-xs" href="<?php echo routing::getInstance()->getUrlWeb('credencial', 'insert') ?>"><img class="img-responsive"  id="imgnuevo" src="" alt=" "><?php echo i18n::__('registroCredencial') ?></a>
      ...
      <a href="<?php echo routing::getInstance()->getUrlWeb('credencial', 'deleteFilters') ?>" class="btn  btn-xs" ><img class="img-responsive"  id="imgelifiltro" src="" alt=" "><?php echo i18n::__('eFiltros') ?></a>
            ...
            <form class="form-horizontal" id="filterForm" role="form" action="<?php echo routing::getInstance()->getUrlWeb('credencial', 'index') ?>" method="POST">
              ...
              <?php if (session::getInstance()->hasError('inputFecha')): ?>
                  ...
                  <?php endif ?>
                    ...
                    <div class="col-sm-6">
                      <label class="col-sm-4 control-label"  for="<?php echo credencialTableClass::getNameField(credencialTableClass::CREATED_AT, true) . '_1' ?>"><?php echo i18n::__('fecha inicio') ?></label>
                    ...
                    <div class="col-sm-6">
                      <label class="col-sm-4 control-label" for="<?php echo credencialTableClass::getNameField(credencialTableClass::CREATED_AT, true) . '_2' ?>"><?php echo i18n::__('fecha fin') ?></label>
