    ...
    <div class="center-block" id="cuerpo2">
      ...
      <ul>
        <?php if (session::getInstance()->hasCredential('admin')): ?>
          <a class="btn btn-xs" href="<?php echo routing::getInstance()->getUrlWeb('cliente', 'insertCliente') ?>"><img class="img-responsive"  id="imgnuevo" src="" alt=" "><?php echo i18n::__('registroCliente') ?></a> 
              ...
              <form class="form-horizontal" id="filterForm" role="form" method="POST" action="<?php echo routing::getInstance()->getUrlWeb('cliente', 'indexCliente') ?>">
                 ...
                 <?php if (session::getInstance()->hasError('inputFecha')): ?>
                  ...
                  <?php endif ?>
                    ...
                    <div class="col-sm-6">
                      <label class="col-sm-4 control-label"  for="<?php echo clienteTableClass::getNameField(clienteTableClass::CREATED_AT, true) . '_1' ?>"  ><?php echo i18n::__('fecha inicio') ?></label>
                    ...
                    <div class="col-sm-6">
                      <label class="col-sm-4 control-label"  for="<?php echo clienteTableClass::getNameField(clienteTableClass::CREATED_AT, true) . '_2' ?>"  ><?php echo i18n::__('fecha fin') ?></label>
