...
<div class="container container-fluid" id="cuerpo">
  ...
  <?php view::includeHandlerMessage()?>
    <div class="form-group">
      ...
      <div class="col-sm-10"> 
        <input  class="form-control" value="<?php echo ((isset($objTI) == true) ? $objTI[0]->$descripcion : '') ?>" type="text" name="<?php echo tipoIdTableClass::getNameField(tipoIdTableClass::DESCRIPCION, true) ?>" placeholder="<?php echo i18n::__('des') ?>" required>
      </div>
    </div>  
      
      <input class="btn btn-lg btn-primary btn-xs"  type="submit" value="<?php echo i18n::__(((isset($objTI)) ? 'update' : 'register')) ?>">
      <a class="btn btn-lg btn-danger btn-xs" href="<?php echo routing::getInstance()->getUrlWeb('cliente', 'indexTipoId') ?>" ><?php echo i18n::__('atras') ?></a>
