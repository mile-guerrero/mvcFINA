...
<?php endif ?>
    ...
    <div class="form-group">
      ...
      <div class="col-sm-10">
        <input class="form-control" value="<?php echo ((isset($objTrabajador) == true) ? $objTrabajador[0]->$nombre : '') ?>" type="text" name="<?php echo trabajadorTableClass::getNameField(trabajadorTableClass::NOMBRET, true) ?>">
      </div>
    </div>  
    ...
    <div class="form-group">
      ...
      <div class="col-sm-10">            
        <input class="form-control" value="<?php echo ((isset($objTrabajador) == true) ? $objTrabajador[0]->$apellido : '') ?>" type="text" name="<?php echo trabajadorTableClass::getNameField(trabajadorTableClass::APELLIDO, true) ?>">
      </div>
    </div> 
    ...
    <div class="form-group">
      ...
      <div class="col-sm-10">             
        <input class="form-control" value="<?php echo ((isset($objTrabajador) == true) ? $objTrabajador[0]->$direccion : '') ?>" type="text" name="<?php echo trabajadorTableClass::getNameField(trabajadorTableClass::DIRECCION, true) ?>">
      </div>
    </div>
    ...
    <div class="form-group">
      ...
      <div class="col-sm-10">              
        <input class="form-control" value="<?php echo ((isset($objTrabajador) == true) ? $objTrabajador[0]->$telefono : '') ?>" type="text" name="<?php echo trabajadorTableClass::getNameField(trabajadorTableClass::TELEFONO, true) ?>">
      </div>
    </div>
    ...
    <div class="form-group">
      ...
      <div class="col-sm-10">              
        <input class="form-control" value="<?php echo ((isset($objTrabajador) == true) ? $objTrabajador[0]->$email : '') ?>" type="text" name="<?php echo trabajadorTableClass::getNameField(trabajadorTableClass::EMAIL, true) ?>">
      </div>
    </div>
