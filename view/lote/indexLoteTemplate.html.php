      ...
      <article id='derecha'>
        ...
        <ul>
          ...
          <a href="<?php echo routing::getInstance()->getUrlWeb('lote', 'deleteFiltersLote') ?>" class="btn  btn-xs" ><img class="img-responsive"  id="imgelifiltro" src="" alt=" "><?php echo i18n::__('eFiltros') ?></a> 
           <a class="btn btn-xs" target="_blank" href="<?php echo routing::getInstance()->getUrlWeb('lote', 'reportLote') ?>" ><img class="img-responsive"  id="imgreporte" src="" alt=" "><?php echo i18n::__('informe') ?></a>                    
        </ul> 
