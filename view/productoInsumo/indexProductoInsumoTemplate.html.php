...
<!--                <label  class="col-sm-2 control-label"><?php echo i18n::__('fecha fin') ?></label>-->
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <select class="form-control" id="filterUnidadMedida" name="filter[unidadMedida]">
                    <option value=""><?php echo i18n::__('FUnidadMedida') ?></option>
                    <?php foreach ($objUM as $UM): ?>
              ...
              <div class="form-group">
                <label for="filterTipoInsumo" class="col-sm-2 control-label"><?php echo i18n::__('tipo') ?></label>
                <div class="col-sm-10">
                  <select class="form-control" id="filterTipoInsumo" name="filter[tipoInsumo]">
                    <option value=""><?php echo i18n::__('FTipoInsumo') ?></option>
                    <?php foreach ($objPITPI as $TP): ?>
                      <option value="<?php echo $TP->$idtipo ?>"><?php echo $TP->$destipo ?></option>  
                    <?php endforeach; ?>
                  </select>    
                </div> 
              </div>
