...
<div class="container container-fluid" id="cuerpo">
  ...
  <article id="derecha">
    ...
    <ul>      
      ...
      <a class="btn btn-xs" href="<?php echo routing::getInstance()->getUrlWeb('manoObra', 'insert') ?>"><img class="img-responsive"  id="imgnuevo" src="" alt=" "><?php echo i18n::__('registroManoObra') ?></a> 
            ...
            <form class="form-horizontal" id="filterForm" role="form" action="<?php echo routing::getInstance()->getUrlWeb('manoObra', 'index') ?>" method="POST">
                 <?php if (session::getInstance()->hasFlash('modalFilters') === true): ?>        
                  ...
                  <?php endif ?>
                     ...
                     <div class="form-group">
                    <div class="col-sm-6">
                      <label class="col-sm-4 control-label"  for="<?php echo manoObraTableClass::getNameField(manoObraTableClass::CREATED_AT, true) . '_1' ?>" ><?php echo i18n::__('fecha inicio') ?></label>
                    ...
                    <div class="col-sm-6">
                      <label class="col-sm-4 control-label" for="<?php echo manoObraTableClass::getNameField(manoObraTableClass::CREATED_AT, true) . '_2' ?>" ><?php echo i18n::__('fecha fin') ?></label>
