...
<div class="container container-fluid" id="cuerpo">
  <div class="center-block" id="cuerpo4">
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form class="form-horizontal" id="filterForm" role="form" action="<?php echo routing::getInstance()->getUrlWeb('controlEnfermedad', 'index') ?>"  method="POST" >
              ...
              <?php if (session::getInstance()->hasError('inputFecha')): ?>
                  ...
                  <?php endif ?>
                    ...
                    <div class="col-sm-6">
                        <label class="col-sm-4 control-label"  for="<?php echo controlEnfermedadTableClass::getNameField(controlEnfermedadTableClass::CREATED_AT, true) . '_1' ?>"><?php echo i18n::__('fecha inicio') ?></label>
                        <input type="date" class="form-control-filtro1" id="<?php echo controlEnfermedadTableClass::getNameField(controlEnfermedadTableClass::CREATED_AT, true).'_1' ?>" name="filter[<?php echo controlEnfermedadTableClass::getNameField(controlEnfermedadTableClass::CREATED_AT, true).'_1' ?>]">

                    </div>
                    <div class="col-sm-6">
                      <label class="col-sm-4 control-label" for="<?php echo controlEnfermedadTableClass::getNameField(controlEnfermedadTableClass::CREATED_AT, true) . '_2' ?>"><?php echo i18n::__('fecha fin') ?></label>
                            <input type="date" class="form-control-filtro2" id="<?php echo controlEnfermedadTableClass::getNameField(controlEnfermedadTableClass::CREATED_AT, true).'_2' ?>" name="filter[<?php echo controlEnfermedadTableClass::getNameField(controlEnfermedadTableClass::CREATED_AT, true).'_2' ?>]">
    ...
    <div class="col-sm-10">
      <select class="form-control" id="filterLote" name="filter[<?php echo controlEnfermedadTableClass::getNameField(controlEnfermedadTableClass::LOTE_ID, true) ?>]">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form target="_blank" class="form-horizontal" id="reportForm" role="form" method="POST" action="<?php echo routing::getInstance()->getUrlWeb('controlEnfermedad', 'report')?>">
