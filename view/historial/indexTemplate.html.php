...
<div class="container container-fluid" id="cuerpo">
  ...
  <section id="">
    ...
    <ul>
      ...
      <a class="btn  btn-xs" href="<?php echo routing::getInstance()->getUrlWeb('historial', 'insert') ?>"><img class="img-responsive"  id="imgnuevo" src="" alt=" "><?php echo i18n::__('registroHistorial') ?></a> 
      <?php endif?>
            ...
            <form class="form-horizontal" id="filterForm" role="form" action="<?php echo routing::getInstance()->getUrlWeb('historial', 'index') ?>" method="POST">
               ...
               <?php if (session::getInstance()->hasError('inputFecha')): ?>
                  ...
                  <?php endif ?>
                    ...
                    <div class="col-sm-6">
                      <label class="col-sm-4 control-label"  for="<?php echo historialTableClass::getNameField(historialTableClass::CREATED_AT, true) . '_1' ?>"  ><?php echo i18n::__('fecha inicio') ?></label>
                    ...
                    <div class="col-sm-6">
                      <label class="col-sm-4 control-label"  for="<?php echo historialTableClass::getNameField(historialTableClass::CREATED_AT, true) . '_2' ?>" ><?php echo i18n::__('fecha fin') ?></label>
