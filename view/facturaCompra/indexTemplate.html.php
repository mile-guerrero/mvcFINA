...
<div class="container container-fluid" id="cuerpo">
  ...
  <section id="">
    ...
    <ul>      
      <a class="btn btn-xs" href="<?php echo routing::getInstance()->getUrlWeb('facturaCompra', 'insert') ?>"><img class="img-responsive"  id="imgnuevo" src="" alt=" "><?php echo i18n::__('nuevo') ?></a> 
      ...
      <a href="<?php echo routing::getInstance()->getUrlWeb('facturaCompra', 'index') ?>" class="btn btn-xs" ><img class="img-responsive"  id="imgelifiltro" src="" alt=" "><?php echo i18n::__('eFiltros') ?></a>             
    </ul> 
