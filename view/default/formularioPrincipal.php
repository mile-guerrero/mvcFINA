...
<form   class="form-horizontal" role="form" class="form-horizontal" role="form"  method="post" action="<?php echo routing::getInstance()->getUrlWeb('default', ((isset($objUsuarios)) ? 'update' : 'create')) ?>">
 ...
 <?php view::includeHandlerMessage()?>
  ...
  <div class="form-group">
      ...
      <div class="col-sm-10"> 
        <input class="form-control" value="<?php echo ((isset($objUsuarios)==true) ? $objUsuarios[0]->$password : '') ?>" type="password" name="<?php echo usuarioTableClass::getNameField(usuarioTableClass::PASSWORD, true) ?>" placeholder="<?php echo i18n::__('pass') ?>" required>
      </div>
  </div>    
