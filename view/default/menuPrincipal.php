        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
                    ...
                    <li class=""><a id="colorletra" href="<?php echo routing::getInstance()->getUrlWeb('lote', 'indexLote') ?>"><?php echo i18::__('lote') ?> <span class="sr-only">(current)</span></a></li>
                    <li class="dropdown">
                        <a href="#" id="colorletra" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false"><?php echo i18::__('product') ?> <span class="caret"></span></a>
                    ...
                    <li class="dropdown">
                        <a id="colorletra" href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false"><?php echo i18::__('personas') ?> <span class="caret"></span></a>
                        <ul class="dropdown-menu" role="menu">
                            <?php if (session::getInstance()->hasCredential('admin')): ?>
                    ...
                    <li class="dropdown">
                        <a id="colorletra" href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false"><?php echo i18::__('documentos') ?> <span class="caret"></span></a>
                        <ul class="dropdown-menu" role="menu">
                    ...
                    <li class="dropdown">
            <a id="colorletra" href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false"><?php echo i18::__('otros') ?> <span class="caret"></span></a>
            <ul class="dropdown-menu" role="menu">
              <?php if (session::getInstance()->hasCredential('admin')): ?>
          ...
          <li class="dropdown">
            <a id="colorletra" href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false"><?php echo i18::__('subir archivos') ?> <span class="caret"></span></a>
            <ul class="dropdown-menu" role="menu">
               ...
               <li><a  href="<?php echo routing::getInstance()->getUrlWeb('video', 'index') ?>"><?php echo i18::__('video') ?></a></li>
                ...
                <ul class="nav navbar-nav navbar-right">
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu" role="menu">
                            <a id="colorletra" href="#"><img id="imgPerfil" class="img-rounded center-block" src="" alt=""></a>
                            <br>
                ...
                <li class="dropdown">
                    <a id="colorletra" href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false"><?php echo i18::__('idioma') ?><span class="caret"></span></a>
                    <ul class="dropdown-menu" role="menu">
