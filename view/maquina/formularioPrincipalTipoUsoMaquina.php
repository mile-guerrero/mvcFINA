...
<div class="container container-fluid" id="cuerpo">
  ...
  <form  class="form-horizontal" role="form" method="post" action="<?php echo routing::getInstance()->getUrlWeb('maquina', 'createTipoUsoMaquina') ?>">
    ...
    <div class="form-group">
      ...
      <div class="col-sm-10">
        <input class="form-control" value="<?php echo ((isset($objTUM) == true) ? $objTUM[0]->$descripcion : '') ?>" type="text" name="<?php echo tipoUsoMaquinaTableClass::getNameField(tipoUsoMaquinaTableClass::DESCRIPCION, true) ?>">
      </div>
    </div>
