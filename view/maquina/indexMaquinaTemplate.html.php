...
<h1><?php echo i18n::__('maquina') ?></h1>
      ...
      <a class="btn  btn-xs" href="<?php echo routing::getInstance()->getUrlWeb('maquina', 'insertMaquina') ?>"><img class="img-responsive"  id="imgnuevo" src="" alt=" "><?php echo i18n::__('registroMaquina') ?></a> 
      ...
      <a href="<?php echo routing::getInstance()->getUrlWeb('maquina', 'deleteFiltersMaquina') ?>" class="btn btn-xs" ><img class="img-responsive"  id="imgelifiltro" src="" alt=" "><?php echo i18n::__('eFiltros') ?></a> 
          ...
          <div class="modal-body">
            <form class="form-horizontal" id="filterForm" role="form" action="<?php echo routing::getInstance()->getUrlWeb('maquina', 'indexMaquina') ?>" method="POST">
              ...
              <div class="form-group">
                    <div class="col-sm-6">
                      <label class="col-sm-4 control-label"  for="<?php echo maquinaTableClass::getNameField(maquinaTableClass::CREATED_AT, true) . '_1' ?>"  ><?php echo i18n::__('fecha inicio') ?></label>
                    ...
                    <div class="col-sm-6">
                      <label class="col-sm-4 control-label"  for="<?php echo maquinaTableClass::getNameField(maquinaTableClass::CREATED_AT, true) . '_2' ?>" ><?php echo i18n::__('fecha fin') ?></label>
...
<!---Informes--->
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form target="_blank" class="form-horizontal" id="reportForm" role="form" method="POST" action="<?php echo routing::getInstance()->getUrlWeb('maquina', 'reportMaquina')?>">
