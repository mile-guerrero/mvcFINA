...
<h1><?php echo i18n::__('nomProveedor') ?></h1>
      ...
      <a class="btn  btn-xs" href="<?php echo routing::getInstance()->getUrlWeb('maquina', 'insertProveedor') ?>"><img class="img-responsive"  id="imgnuevo" src="" alt=" "><?php echo i18n::__('registroProveedor') ?></a> 
  ...
  <div class="modal-dialog">
        ...
        <form target="_blank" class="form-horizontal" id="filterForm" role="form" method="POST" action="<?php echo routing::getInstance()->getUrlWeb('maquina', 'indexProveedor')?>">
          ...
          <?php if (session::getInstance()->hasError('inputFecha')): ?>
                  ...
                  <?php endif ?>
                    ...
                    <div class="col-sm-6">
                      <label class="col-sm-4 control-label"  for="<?php echo proveedorTableClass::getNameField(proveedorTableClass::CREATED_AT, true) . '_1' ?>"   ><?php echo i18n::__('fecha inicio') ?></label>
                       <input type="date" class="form-control-filtro1" id="<?php echo proveedorTableClass::getNameField(proveedorTableClass::CREATED_AT, true).'_1' ?>" name="filter[<?php echo proveedorTableClass::getNameField(proveedorTableClass::CREATED_AT, true).'_1' ?>]">

                    </div>
                    <div class="col-sm-6">
                      <label class="col-sm-4 control-label"  for="<?php echo proveedorTableClass::getNameField(proveedorTableClass::CREATED_AT, true) . '_2' ?>"  ><?php echo i18n::__('fecha fin') ?></label>
                        <input type="date" class="form-control-filtro2" id="<?php echo proveedorTableClass::getNameField(proveedorTableClass::CREATED_AT, true).'_2' ?>" name="filter[<?php echo proveedorTableClass::getNameField(proveedorTableClass::CREATED_AT, true).'_2' ?>]">
    ...
    <div class="col-sm-10">
      <select class="form-control" id="filterCiudad" name="filter[<?php echo proveedorTableClass::getNameField(proveedorTableClass::ID_CIUDAD, true) ?>]">
...
<?php endforeach; ?>
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" id="filterDocumento" name="filter[<?php echo proveedorTableClass::getNameField(proveedorTableClass::DOCUMENTO, true) ?>]" placeholder="buscar por documento">
    </div>
  </div>
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" id="filterNombre" name="filter[<?php echo proveedorTableClass::getNameField(proveedorTableClass::NOMBREP, true) ?>]" placeholder="buscar por nombre">
    </div>
  </div>
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" id="filterApellido" name="filter[<?php echo proveedorTableClass::getNameField(proveedorTableClass::APELLIDO, true) ?>]" placeholder="buscar por apellido">
    </div>
  </div>
...
<!---Informes--->
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
          <form class="form-horizontal" target="_blank" id="reportForm" role="form" method="POST" action="<?php echo routing::getInstance()->getUrlWeb('maquina', 'reportProveedor')?>">
...
<?php endforeach; ?>
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" id="reportDocumento" name="report[documento]" placeholder="buscar por documento">
    </div>
  </div>
