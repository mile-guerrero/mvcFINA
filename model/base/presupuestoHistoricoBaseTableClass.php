...
/**
 * Description of presupuestoHistoricoBaseTableClass
 *
 * 
 */
class presupuestoHistoricoBaseTableClass extends tableBaseClass {

 private $id;  
 private $loteId;
 private $presupuesto;
 private $totalProduccion;
 private $totalPagoTrabajador;
 ...
 private $deletedAt;
  ...
  const TOTAL_PRODUCCION = 'total_produccion';
  const TOTAL_PRODUCCION_LENGTH = 30;  
  const TOTAL_PAGO_TRABAJADOR = 'total_pago_trabajador';
  const TOTAL_PAGO_TRABAJADOR_LENGTH = 30; 
  ...
  public function get_totalProduccion() {
    return $this->totalProduccion;
  }

  public function get_totalPagoTrabajador() {
    return $this->totalPagoTrabajador;
  }
  ...
  public function set_totalProduccion($totalProduccion) {
    $this->totalProduccion = $totalProduccion;
  }

  public function set_totalPagoTrabajador($totalPagoTrabajador) {
    $this->totalPagoTrabajador = $totalPagoTrabajador;
  }
