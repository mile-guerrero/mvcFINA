...
namespace mvc\validator {
   ...
   */
  class viveroValidatorClass extends validatorClass {
    public static function validateInsert() {
      ...
      if (self::notBlank(request::getInstance()->getPost(\viveroTableClass::getNameField(\viveroTableClass::CANTIDAD, true)))) {
        ...
        //-------------------------------campo Producto-----------------------------
          //----campo nulo----
      } if (self::notBlank(request::getInstance()->getPost(\viveroTableClass::getNameField(\viveroTableClass::PRODUCTO_INSUMO_ID, true)))) {
        $flag = true;
