  ...
  public function execute() {
    try {
      ...
      if (request::getInstance()->hasPost('report')) {
        ...
        if (isset($report['producto']) and $report['producto'] !== null and $report['producto'] !== '') {
          $where[viveroTableClass::PRODUCTO_INSUMO_ID] = $report['producto'];
        }
//        if (isset($report['cantidad']) and $report['cantidad'] !== null and $report['cantidad'] !== '') {
//          $where[viveroTableClass::CANTIDAD] = $report['cantidad'];
//        }
        ...
        if (isset($report['fecha1']) and $report['fecha1'] !== null and $report['fecha1'] !== '' and (isset($report['fecha2']) and $report['fecha2'] !== null and $report['fecha2'] !== '')) {
          $where[viveroTableClass::CREATED_AT] = array(
      ...
      $this->mensaje = 'Informacion de los Viveros';
      $fields = array(
          viveroTableClass::ID,
      ...
      $this->objVivero = viveroTableClass::getAll($fields, true, $orderBy, 'ASC', null, null,$where);
