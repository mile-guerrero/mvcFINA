  ...
  public function execute() {
    try {
      if (request::getInstance()->isMethod('POST')) {
       ...
       $observacion ='se ha eliminado una seleccion en  tipo producto insumo ';
        log::register('EliminarSeleccion', tipoProductoInsumoTableClass::getNameTable(),$observacion,$id);
